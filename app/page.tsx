...
const vantagens = [
  {
    ...
    description:
      "Conte com a solidez e segurança das melhores operadoras para garantir o melhor atendimento. Qualidade incomparável.",
  },
  {
  ...
  },
  {
    ...
    description: "As operadoras oferecem acesso a descontos em farmácias, vacinas e muito mais.",
  },
]
...
const faqs = [
  {
    ...
    answer:
      "Para consultar os valores dos planos de saúde, basta clicar no botão 'Cotação Online' ou entrar em contato conosco pelo WhatsApp.",
  },
  {
    question: "Como Vejo a Rede Credenciada dos Planos?",
    answer:
      "Trabalhamos com as maiores operadoras do Brasil. Basta solicitar uma cotação e nossos corretores enviarão todas as informações da rede credenciada.",
  },
  {
    question: "Quais os Benefícios de Ter um Plano de Saúde?",
    answer:
      "Os planos de saúde oferecem cobertura nacional, atendimento 24 horas, telemedicina, programas de prevenção e bem-estar.",
  },
]
        ...
        >
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center py-10 sm:py-14 lg:py-20">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-5 lg:mb-6 max-w-4xl mx-auto leading-tight">
              Cote Conosco o Seu Plano de Saúde SualAmérica 
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              <Link href="/cotacao" className="w-full sm:w-auto">
                <Button className="w-full sm:w-auto bg-[#f97316] hover:bg-[#ea580c] text-white rounded-full px-8 sm:px-10 lg:px-12 py-5 sm:py-6 text-base sm:text-lg lg:text-xl font-semibold shadow-xl">
                  Cotação Online
                </Button>
              </Link>
              <Link href="/corretora/contato" className="w-full sm:w-auto">
                <Button className="w-full sm:w-auto bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full px-8 sm:px-10 lg:px-12 py-5 sm:py-6 text-base sm:text-lg lg:text-xl font-semibold shadow-xl flex items-center justify-center gap-3">
                  Cote no WhatsApp
                  <Image
