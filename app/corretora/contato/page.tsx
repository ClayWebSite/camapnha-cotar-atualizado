...
function ContatoContent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const message = encodeURIComponent(`Olá! Meu nome é ${name} e gostaria de cotar um plano ${operadora.name}.`)
      window.location.href = `https://wa.me/${fullPhone}?text=${message}`
    }, 3000)
  }
