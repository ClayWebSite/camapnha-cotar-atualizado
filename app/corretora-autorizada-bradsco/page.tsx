...
const BRAND_COLOR = "#cc092f"
const BRAND_HOVER = "#a00725"
...
const faqs = [
  {
    ...
    answer:
      "Para consultar os valores dos planos de saúde Bradesco, basta clicar no botão 'Cotação Online' ou entrar em contato conosco pelo WhatsApp.",
  },
  {
    question: "Como Vejo a Rede Credenciada dos Planos?",
    answer:
      "A rede credenciada da Bradesco Saúde é uma das mais completas do Brasil. Basta solicitar uma cotação e nossos corretores enviarão todas as informações.",
  },
  {
    question: "Quais os Benefícios de Ter o Plano de Saúde Bradesco?",
    answer:
      "Os planos Bradesco Saúde oferecem cobertura nacional, atendimento 24 horas, telemedicina, programas de prevenção e bem-estar.",
  },
]

export default function CorretoraBradescoPage() {
  return (
    <main className="min-h-screen">
      <Header customTitle="Cotar Plano Bradesco" />
        ...
        >
          <div className="absolute inset-0 bg-black">
            <div
              ...
              style={{
                backgroundImage: `url('https://www.paxbahia.com.br/images/bl/5-beneficios-da-assistencia-familiar.jpg')`,
                opacity: 0.35,
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center py-10 sm:py-14 lg:py-20">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-5 lg:mb-6 max-w-4xl mx-auto leading-tight">
              Cote Conosco o Seu Plano de Saúde Bradesco
            </h1>
            ...
            <p className="text-sm font-semibold text-white mb-8 sm:mb-10 lg:mb-12 max-w-xl mx-auto sm:text-base">
              Faça uma cotação agora mesmo. Veja valores, rede credenciada e muito mais.
            </p>
            {/* End of headline change */}

            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              <Link href="/cotacao?operadora=bradesco" className="w-full sm:w-auto">
                <Button
              ...
              <Link href="/corretora/contato?operadora=bradesco" className="w-full sm:w-auto">
      ...
      {/* Vantagens Section - borda vermelha Bradesco */}
            ...
            {vantagens.map((vantagem, index) => (
              <div key={index} className="flex items-start gap-4 flex-1">
                ...
                <div className="flex-1">
                  ...
                  {vantagem.hasLink && (
                    <Link
                      href="/cotacao?operadora=bradesco"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:hidden">
              ...
              <div className="w-full flex justify-center mb-6">
                <div className="relative w-full max-w-md">
                  <div className="bg-gray-100 rounded-2xl p-2">
                    <img
                      src="https://cdn6.campograndenews.com.br/uploads/noticias/2023/10/20/7401f25cce7c7bf678b653707c77da1fda0b2165.jpg"
                      alt="Atendimento médico Bradesco"
              ...
              <p className="text-[#64748b] text-sm sm:text-base mb-6 leading-relaxed">
                Indicamos a <span className="font-semibold text-[#1a3a5c]">Bradesco Saúde</span> pois possui planos
      ...
      {/* FAQ Section - botão vermelho Bradesco */}
