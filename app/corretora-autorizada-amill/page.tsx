...
const BRAND_COLOR = "#004a93"
const BRAND_HOVER = "#003670"
...
const vantagens = [
  {
    iconUrl: "https://i.imgur.com/RnqmXFg.png",
    title: "Qualidade e Segurança",
    description:
      "Conte com a solidez e segurança da operadora para garantir o melhor atendimento. Qualidade incomparável.",
  },
  {
    iconUrl: "https://i.imgur.com/QytaT9k.png",
    title: "Cobertura Abrangente",
    description: "Planos completos para pessoas físicas, famílias, empresas e MEI.",
    hasLink: true,
  },
  {
    iconUrl: "https://i.imgur.com/12LRe0P.png",
...
const faqs = [
  {
    ...
    answer:
      "Para consultar os valores dos planos de saúde Amil, basta clicar no botão 'Cotação Online' ou entrar em contato conosco pelo WhatsApp.",
  },
  {
    question: "Como Vejo a Rede Credenciada dos Planos?",
    answer:
      "A rede credenciada da Amil é uma das mais completas do Brasil. Basta solicitar uma cotação e nossos corretores enviarão todas as informações.",
  },
  {
    question: "Quais os Benefícios de Ter o Plano de Saúde Amil?",
    answer:
      "Os planos Amil oferecem cobertura nacional, atendimento 24 horas, telemedicina, programas de prevenção e bem-estar.",
  },
]

export default function CorretoraAmilPage() {
  return (
    <main className="min-h-screen">
      <Header customTitle="Cotar Plano Amil" />
        ...
        >
          <div className="absolute inset-0 bg-black">
            <div
              ...
              style={{
                backgroundImage: `url('https://i.imgur.com/sRJEYpG.png')`,
                opacity: 0.4,
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center py-10 sm:py-14 lg:py-20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              <Link href="/cotacao?operadora=amil" className="w-full sm:w-auto">
                <Button
              ...
              <Link href="/corretora/contato?operadora=amil" className="w-full sm:w-auto">
      ...
      {/* Vantagens Section - borda azul Amil */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:hidden">
              ...
              <div className="w-full flex justify-center mb-6">
                <div className="relative w-full max-w-md">
                  <div className="bg-gray-100 rounded-2xl p-2">
                    <img
                      src="https://i.imgur.com/uFtQIWE.jpeg"
                      alt="Planos de saúde Amil"
              ...
              <p className="text-[#64748b] text-sm sm:text-base mb-6 leading-relaxed">
                Indicamos a <span className="font-semibold text-[#1a3a5c]">Amil</span> por oferecer planos completos
                para pessoas físicas, famílias, empresas e MEI, com ampla rede credenciada e soluções modernas em saúde.
              </p>
            ...
            <div className="hidden lg:flex lg:flex-row items-start gap-8 lg:gap-16">
              <div className="w-full lg:w-1/2">
                ...
                <p className="text-[#64748b] text-sm sm:text-base lg:text-lg mb-6 leading-relaxed">
                  Indicamos a <span className="font-semibold text-[#1a3a5c]">Amil</span> por oferecer planos completos
                  para pessoas físicas, famílias, empresas e MEI, com ampla rede credenciada e soluções modernas em
                  saúde.
                </p>
